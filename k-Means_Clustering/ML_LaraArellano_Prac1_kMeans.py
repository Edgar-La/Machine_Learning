...
#import os; os.system('clear')	#A veces uso el comando para limpiar la terminal
...
#Se trató de dividir según los pasos del pseudocódigo mostrado en clase
########################################################################################################################
X = crear_puntos()
